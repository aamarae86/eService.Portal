...
namespace eService.Portal.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class PortalRepositoryBase<TEntity> : PortalRepositoryBase<TEntity, int>, IRepository<TEntity>
