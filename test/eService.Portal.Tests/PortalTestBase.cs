...
using eService.Portal.EntityFrameworkCore.Seed.Host;
using eService.Portal.EntityFrameworkCore.Seed.Tenants;
using eService.Portal.MultiTenancy;

namespace eService.Portal.Tests
{
    public abstract class PortalTestBase : AbpIntegratedTestBase<PortalTestModule>
    {
